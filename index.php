                    ...
                    <li id="<?php echo $row_item['list_item_id'];?>">
                        <div class="card">
                            <div class="card-title text-right">
                                ...
                                <button type="button" class="add-card-btn btn" data-toggle="modal" data-target="#delete<?php echo $row['list_item_id']?>"><i class="fa fa-trash" aria-hidden="true"></i></button>
                            </div>
                            <div class="card-body">
